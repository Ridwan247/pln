...
<body>
    <div class="left-sidebar-pro">
      ...
      <div class="sidebar-brand-text ">PT.PLN (PERSERO)</div> </a>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li>
                                    <a href="logout.php" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Keluar</span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
